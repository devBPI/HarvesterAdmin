...
<body name="haut" id="haut" style="height: auto; width: auto;">
	<FORM action="TraductionRulesSet.php?modify=true" method="post" style="margin-top:5%" class="left" onsubmit="return confirm('Voulez vous vraiment modifier les ensembles de règles ?');">
		<h2>Ensembles de règles</h2>
		...
		<input type="submit" value="Valider" class="button primairy-color round"/>
				<?php } 
					...
					echo "</table></div><a href='TraductionRulesSet.php?modify=false'>Modifier</a></div>";
				}?>
	</FORM>
</body>
</html>