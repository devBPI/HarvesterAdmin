...
//var_dump($configuration);
	...
	$data_to_show["general_infos"] = Gateway::getDataToShowByGroup("PROCESS", true, "general_infos");
	$data_to_show["follow_up"] = Gateway::getDataToShowByGroup("PROCESS", true, "follow_up");
	$data_to_show["number_of_results_infos"] = Gateway::getDataToShowByGroup("PROCESS", true, "number_of_results_infos");
	$data_to_show_for_display = Gateway::getDataToShow("PROCESS", false);
